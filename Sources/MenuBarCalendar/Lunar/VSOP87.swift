...
/// Truncated VSOP87D coefficients for Earth, as tabulated in Meeus,
/// *Astronomical Algorithms*, Appendix II.
///
/// Each row is `[A, B, C]`, contributing `A * cos(B + C * tau)` where tau is in
/// Julian millennia. `earthL` is heliocentric longitude (units of 1e-8 rad),
/// `earthR` is the radius vector (units of 1e-8 AU).
extension SolarTerms {

    static let earthL: [[[Double]]] = [l0, l1, l2, l3, l4, l5]
    static let earthR: [[[Double]]] = [r0, r1, r2]

    // MARK: L0 — 64 terms
    private static let l0: [[Double]] = [
    ...
    // MARK: L4 — 3 terms
    private static let l4: [[Double]] = [
        [114, 3.142, 0], [8, 4.13, 6283.08], [1, 3.84, 12566.15],
    ]

    // MARK: L5 — 1 term
    private static let l5: [[Double]] = [
        [1, 3.14, 0],
    ]

    // MARK: R0 — 40 terms
    private static let r0: [[Double]] = [
